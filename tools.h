...
void leerMallayCondiciones(mesh &m){
    char filename[14];
    ifstream file;
    float l, taf, kapa, lamda, ipsilon, psi, alfa, delta, ita;
    ...
    file >> l >> taf >> kapa >> lamda >> ipsilon >> psi >> alfa >> delta >> ita;
    file >> nnodes >> neltos >> ndirich_u >> ndirich_p;


    m.setParameters(l,taf, kapa, lamda, ipsilon, psi, alfa, delta, ita);
