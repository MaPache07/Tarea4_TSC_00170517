...
enum parameters {ELEMENT_LENGTH,TAF,KAPA,LAMDA,IPSILON,PSI,ALFA,DELTA,ITA};
...
public:
    void setParameters(float l, float taf, float kapa, float lamda, float ipsilon, float psi, float alfa, float delta, float ita){
        parameters[ELEMENT_LENGTH] = l;
        parameters[TAF] = taf;
        parameters[KAPA] = kapa;
        parameters[LAMDA] = lamda;
        parameters[IPSILON] = ipsilon;
        parameters[PSI] = psi;
